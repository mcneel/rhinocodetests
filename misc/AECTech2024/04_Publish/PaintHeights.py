...
class Brush(GetPoint):
    def __init__(self, brush_surface):
        ...
        # Adding options
        self.sizeIndex = self.AddOptionDouble("BrushSize", self.optsizedouble)
        self.fosizeIndex = self.AddOptionDouble("FalloffSize", self.optfalloffdouble)
        self.strengthIndex = self.AddOptionDouble("Strength", self.optstrengthdouble)
