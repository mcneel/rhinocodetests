...
namespace RhinoCodePlatform.Rhino3D.Tests
{
    ...
    public class RhProjTests : ScriptFixture
    {
        ...
        public void TestRhProj_Build_Rhino(string rhprojfile)
        {
            ...
            project.Package(s_host, project.Settings.PackageBuild, new NUnitProgressReporter());
            ...
            Assert.IsTrue(File.Exists(Path.Combine(buildPath, "rh8", "testsingle-0.1.1234-rh8-any.yak")));
        ...
        public void TestRhProj_Build_Grasshopper(string rhprojfile)
        {
            ...
            Assert.IsTrue(File.Exists(Path.Combine(buildPath, "rh8", "testsinglecomponent-0.1.1234-rh8-any.yak")));
        ...
        public void TestRhProj_Build_Resources(string rhprojfile)
        {
            ...
            string yakFile = Path.Combine(buildPath, "rh8", "testresources-0.1.1234-rh8-any.yak");
        ...
        public void TestRhProj_Build_RhinoGH7(string rhprojfile)
        {
            ...
            Assert.IsTrue(File.Exists(Path.Combine(buildPath, "rh7", "testrhino7build-0.1.1234-rh7-any.yak")));
        ...
        public void TestRhProj_Build_RhinoGH7_WithImages(string rhprojfile)
        {
            ...
            Assert.IsTrue(File.Exists(Path.Combine(buildPath, "rh7", "testrhino7buildwithimage-0.1.1234-rh7-any.yak")));
        ...
        public void TestRhProj_Build_RhinoGH7_Fail(string rhprojfile)
        {
            ...
            {
                project.Package(s_host, project.Settings.PackageBuild, new SilentProgressReporter());
            });
        ...
        public void TestRhProj_BuildError_OldProjectFormat(string rhprojfile)
        {
            ...
            ProjectBuildException ex = Assert.Throws<ProjectBuildException>(() =>
            {
                projectNoHost.Package(s_host, project.Settings.PackageBuild, new SilentProgressReporter());
            });
        ...
        public void TestRhProj_RhinoGH8_HiddenCommandWithIconShouldNotBeInToolbar(string rhprojfile)
        {
            ...
            Assert.IsTrue(File.Exists(Path.Combine(buildPath, "rh8", "testhiddencommandwithicon-0.1.1234-rh8-any.yak")));
        ...
        public void TestRhProj_Build_YakVersion(string rhprojfile)
        {
            ...
            string buildPath = Path.Combine(Path.GetDirectoryName(rhprojfile), project.Settings.BuildPath.ToString());
            Assert.IsTrue(File.Exists(Path.Combine(buildPath, "rh8", "testyakversion-0.1.1234-rh8-any.yak")));
        ...
        public void TestRhProj_Build_YakBetaVersion(string rhprojfile)
        {
            ...
            string buildPath = Path.Combine(Path.GetDirectoryName(rhprojfile), project.Settings.BuildPath.ToString());
            Assert.IsTrue(File.Exists(Path.Combine(buildPath, "rh8", "testyakbetaversion-0.1.1234-beta-rh8-any.yak")));
