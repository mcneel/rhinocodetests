...
")
        ...
        public void TestGH1_Component_Params_UnwrapData_Archive()
        {
            ...
            var sv1 = new GHP.Parameters.ScriptVariableParam("a");
            sv1.CreateAttributes();
            sv1.Write(defaultChunk);
            ...
            var sv2 = new GHP.Parameters.ScriptVariableParam("a") { ExpandsItems = false };
            sv2.CreateAttributes();
            sv2.Write(offChunk);
        ...
        public void TestGH1_Component_Execute_UnwrapData_Python3_Dict()
        {
            ...
            IScriptObject script = GHP.Components.Python3Component.Create("Test", @"a = {'x': 1, 'y': 2}");
            script.CaptureOutput = false;
