...
namespace RhinoCodePlatform.Rhino3D.Tests
{
    ...
    public class GrasshopperTests : Rhino.Testing.RhinoTestFixture
    {
        ...
        public void TestGrasshopper1Error()
        {
            ...
            var code = GetGrasshopper().CreateCode(source);
        ...
        {
            var code = GetGrasshopper().CreateCode(filePath);
        ...
        static object s_gh1 = default;

        static ILanguage GetGrasshopper()
        {
            if (s_gh1 is null)
            {
